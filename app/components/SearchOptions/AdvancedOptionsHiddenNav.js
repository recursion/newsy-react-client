...
export default class AdvancedOptionsHiddenNav extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  render() {
    return (
      <div className="field">
...
AdvancedOptionsHiddenNav.propTypes = {
